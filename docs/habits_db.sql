-- Script de creación de base de datos para la aplicación de Diario/Registro de hábitos
-- Creado: 23-04-2025
...
CREATE TABLE IF NOT EXISTS `habit` (
    ...
    `frequency_value` VARCHAR(50) DEFAULT NULL COMMENT 'JSON string for custom frequency',
...
CREATE TABLE IF NOT EXISTS `habit_log` (
    ...
    `notes` TEXT,
    `mood` TINYINT DEFAULT NULL COMMENT 'Escala 1-5',
    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    `updated_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Tabla de metas relacionadas con hábitos
